...
%% Separate files
pts = 16;
ParamsNa1 = [linspace(18.11, 18.20, pts), linspace(19.05, 19.20, pts)] * 1e6; % X
ParamsNa2 = [linspace(18.10, 18.20, pts), linspace(19.04, 19.20, pts)] * 1e6; % Y
ParamsNa3 = [linspace(18.49, 18.545, pts), linspace(18.66, 18.71, pts)] * 1e6; % Z
ParamsCs1 = [linspace(-170, -80, pts), linspace(110, 190, pts) ] * 1e3; % Ax2
ParamsCs2 = [linspace(-170, -80, pts), linspace(110, 190, pts) ] * 1e3; % Ax3
ParamsCs3 = [linspace(5, 25, pts), linspace(50, 75, pts)] * 1e3; % Ax1

ParamsNa1 = ParamsNa1/1e6; ParamsNa2 = ParamsNa2/1e6; ParamsNa3 = ParamsNa3/1e6;
ParamsCs1 = ParamsCs1/1e3; ParamsCs2 = ParamsCs2/1e3; ParamsCs3 = ParamsCs3/1e3;

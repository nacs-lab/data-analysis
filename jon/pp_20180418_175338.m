...
f = load([folder '\20180418\' 'VPAScan_20180418_175338.mat']); % Description
f = load([folder '\20180418\' 'VPAScan_20180418_204937.mat']); % Description
f = load([folder '\20180418\' 'VPAScan_20180418_213233.mat']); % Description
f = load([folder '\20180418\' 'VPAScan_20180418_222821.mat']); % Description
filelist = f.filelist;
...
%     yerrplot = squeeze(yerr(i,m,:));
    ...
    hold on;
    if berror
        errorbar(xplot + 0.298, yplot, yerrplot ,'.');
    else
        plot(xplot + 0.298,  yplot,'.-');
    end
